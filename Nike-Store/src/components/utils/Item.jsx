      ...
      <div className={`relative bg-gradient-to-b ${color} ${shadow} grid items-center justify-items-center rounded-xl py-4 px-5 transition-all duration-700 ease-in-out w-full hover:scale-105`}>
        <div className='grid items-center justify-items-center'>
          ...
          <div className='flex items-center justify-between w-28 my-2'>
            ...
            className='icon-style w-5 h-5 md:w-4 md:h-4 '/><h1 className='md:text-sm font-normal text-slate-100'>{rating}</h1></div>
          </div>

          <div className='flex items-center gap-3'>
            <button type='button' className='bg-white 90 blur-effect-theme button-theme p-0.5 shadow shadow-sky'><ShoppingBagIcon className='icon-style text-slate-900'/></button>
            <button type='button' className='bg-white 90 blur-effect-theme button-theme px-2 py-1 shadow shadow-sky text-sm text-black'>{btn}</button>
          </div>
        </div>
